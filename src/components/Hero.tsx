  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <span className="uppercase tracking-[0.3em] text-orange text-sm font-semibold mb-6 block">
            Fragancias Exclusivas en Decants
          </span>
      ...
      >
        <span className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-2">Scroll</span>
        <div className="w-[1px] h-12 bg-gradient-to-b from-orange to-transparent"></div>
      </motion.div>
    </section>
  );
}
